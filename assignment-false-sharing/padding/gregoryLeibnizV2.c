...
Pi calulation based Gregory Leibniz Series using Pthreads with False Sharing.
...
int main(int argc, char* argv[]) {
    ...
    if (argc != 3) {
        printf("Usage: ./gregoryLeibnizV2 <num_terms> <num_threads>\n");
        return 1;
    }
    ...
    if (numTerms <= 0 || numThreads <= 0) {
        printf("Number of terms and number of threads must be positive integers.\n");
        return 1;
    }
